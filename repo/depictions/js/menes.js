/*
- hopefully guys from http://beta.tmnlsthrn.com won't mind me using this. 
- experimenting on hosting a personal repo.
- this looks really nice on cydia
*/

/* Determine iOS version for Cydia styles
var agent=navigator.userAgent;var ios=agent.match(/.*; CPU (?:iPhone )?OS ([0-9_]*) like Mac OS X[;)]/);ios=ios==null?'6.0':ios[1].replace(/_/g,'.');var stylesheet=$("#stylesheet");if(ios.match(/^[78]($|\.)/)!=null){stylesheet.href("http://beta.tmnlsthrn.com/css/ios78.css")}else{stylesheet.href("http://beta.tmnlsthrn.com/css/fullwidth.css")}
*/
